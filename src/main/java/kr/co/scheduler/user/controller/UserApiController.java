...
public class UserApiController {
    ...
    public ResponseEntity<?> selectProfileImg(Principal principal) throws IOException {

        return new ResponseEntity<>(userService.selectProfileImg(principal.getName()), HttpStatus.OK);
    }
