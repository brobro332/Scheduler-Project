...
<br/><hr/><br/>
  ...
  <span><h4>목표</h4></span>
  <textarea id="goal" placeholder="프로젝트를 통해 이루고자 하는 목표를 간략하게 입력해주세요" style="width: 100%; resize: none; border: 1px solid #d3d3d3; border-radius:5px;"></textarea>

<br/><br/><hr/><br/>

  <div style="display: inline-block; width: 20%;">
  <span><h4>프로젝트 시작일</h4></span>
  <input type="date" style="border: 1px solid #d3d3d3; border-radius:5px;" id="startPRJ">
  </div>
  <div style="display: inline-block; width: 20%;">
  <span><h4>프로젝트 종료일</h4></span>
...
<br/><hr/><br/>
    ...
    <span><h4>주요업무 &nbsp; <button class="btn btn" style="background-color: #956be8; color: white;" id="addMajorTask">+</button></h4></span>

        <div id="boxContainer">
            <!-- 여기에 추가된 박스가 표시될 것입니다. -->
        </div>
</form>
